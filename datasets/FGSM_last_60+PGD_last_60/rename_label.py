...
# def label_rename():
#     all_label_path = "./datasets/FGSM_last_60+PGD_last_60/labels"
#     label_name_list = os.listdir(all_label_path)
#     label_name_list=[name[:-4] for name in label_name_list if not name.endswith("pgd.txt")]
...
# def img_rename():
#     all_img_path = "./datasets/FGSM_last_60+PGD_last_60/images"
